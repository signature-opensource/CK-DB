...
insert into CK.tMCResHtml( ResId, CultureId, Value ) values( 0, 210327884, N'' );
insert into CK.tMCResHtml( ResId, CultureId, Value ) values( 0, 221272233, N'' );
insert into CK.tMCResHtml( ResId, CultureId, Value ) values( 1, 210327884, N'Système' );
insert into CK.tMCResHtml( ResId, CultureId, Value ) values( 1, 221272233, N'System' );
